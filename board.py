...
from piece import (ILLEGAL, LEGAL, Bishop, Color, King, Knight, MoveState,
                   Pawn, Piece, PieceType, Position, Queen, Rook)
        ...
        for color, king in kings.items():
            if king is not None:
                ...
                opposite_color_pieces = [
                    p for p in self.pieces if p.color == opposite_color
                ]
        ...
        if (
            ...
            if (
                ...
                for position in squares_between_:
                    opposite_color_pieces = [
                        p for p in self.pieces if p.color == opponent_color
                    ]
                    for piece in opposite_color_pieces:
